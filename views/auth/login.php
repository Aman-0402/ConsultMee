<main class="flex-1 flex items-center justify-center px-4 py-16">
  <div class="w-full max-w-md">
    <div class="text-center mb-8">
      ...
      <p class="text-slate-500 text-sm">Sign in to your ConsultMee account</p>
    </div>
      ...
      <form method="post" action="/login" class="flex flex-col gap-5">
        ...
        <div>
          <div class="flex items-center justify-between mb-2">
            ...
            <a href="/forgot-password" class="text-xs text-cobalt hover:underline font-medium">Forgot password?</a>
          </div>
          <div class="relative">
        ...
        <button type="submit" name="login" class="w-full py-3.5 rounded-xl bg-cobalt text-white font-semibold hover:bg-blue-700 transition-all shadow-sm mt-1">
          Sign In <i class="bi bi-arrow-right ml-1"></i>
        </button>
      </form>

      <div class="border-t border-slate-100 mt-6 pt-5 text-center">
        <p class="text-slate-500 text-sm">Don't have an account? <a href="/signup" class="text-cobalt hover:underline font-semibold">Sign up free</a></p>
        <p class="text-slate-400 text-xs mt-2">Are you a consultant? <a href="/consultant/login" class="text-cobalt hover:underline font-medium">Login here</a></p>
      </div>
    </div>
  </div>
</main>
