  ...
  <div class="container">
    ...
    <div class="card" style="width: 35rem;">
        <div class="card-body">
            ...
            <div class="link">
                <p>Don't have an account? <a href="csignup.php">Sign up</a></p>
            </div>
            <div class="link">
                <p>Forgot Password? <a href="./cforgot_password">Reset</a></p>
            </div>
        </div>
    </div>
  </div>
  <!--Consultant login Ends-->
  <br>
  <br>
  <!-- Footer -->
  <footer style="padding: 40px 0; color: black; background-color:lavender;" role="contentinfo">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Optional: Trigger default section
